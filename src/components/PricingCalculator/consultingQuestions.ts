...
export type ConsultingAnswers = Record<string, string | boolean | string[] | undefined>;
...
export const CONSULTING_QUESTIONS = [
    {
        ...
        fields: [
            ...
            },
            {
                ...
                condition: (answers: ConsultingAnswers) => answers.entity_type === 'LLC'
            },
...
export const calculateRisk = (answers: ConsultingAnswers) => {
    const risks: { level: string; msg: string }[] = [];
    let highRiskCount = 0;
